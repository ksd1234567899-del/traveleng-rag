...
Otherwise, evaluate the learner's most recent message for THREE things. If ANY of them applies, set "has_issue" to true and fill in "tutor_line" (plus "original_phrase"/"corrected_phrase"); otherwise "has_issue" is false and those three fields are all null.
